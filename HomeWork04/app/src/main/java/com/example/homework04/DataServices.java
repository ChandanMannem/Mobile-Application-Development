...
public class DataServices {
    public static final long DELAY_MIN_MILLI_SECS = 2000;
    public static final long DELAY_MAX_MILLI_SECS = 4000;
    ...
    public static ArrayList<String> getAppCategories(String token) throws RequestException {
        addSomeDelay(DELAY_MAX_MILLI_SECS, DELAY_MIN_MILLI_SECS); //2 seconds delay to emulate the network delay.
        if(token == null){
    ...
    public static ArrayList<App> getAppsByCategory(String token, String category) throws RequestException {
        ...
        if(token == null){
            ...
            if(account == null){
                ...
                throw new RequestException("Category is required!");
    ...
    public static String login(String email, String password) throws RequestException {
        addSomeDelay(DELAY_MAX_MILLI_SECS, DELAY_MIN_MILLI_SECS); //delay to emulate the network delay.
        String emailPattern = "[a-zA-Z0-9._-]+@[a-z]+\\.+[a-z]+";
        if(email == null || email.isEmpty() ){
            throw  new RequestException("Email cannot be empty!");
        } else if (!email.matches(emailPattern)){
            throw new RequestException("Enter a valid Email!");
        } else {
    ...
    public static String register(String name, String email, String password) throws RequestException {
        addSomeDelay(DELAY_MAX_MILLI_SECS, DELAY_MIN_MILLI_SECS); //delay to emulate the network delay.
        String emailPattern = "[a-zA-Z0-9._-]+@[a-z]+\\.+[a-z]+";
    ...
    public static Account update(String token, String name, String password) throws RequestException {
        addSomeDelay(DELAY_MAX_MILLI_SECS, DELAY_MIN_MILLI_SECS); //delay to emulate the network delay.
        if(token == null){
            throw new RequestException("Token is required!");
        } else {
